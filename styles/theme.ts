export const theme = {
  light: {
    colors: {
      primary: "#16423C", // Main green
      secondary: "#6A9C89", // Lighter green
      ...
      activeBackground: "#F0F0F0", // Light gray background for active items
      contrast: "#FFFFFF", // White for contrast
      mutedText: "#808080", // Muted gray text
      errorBackground: "#808080", // Muted gray text
